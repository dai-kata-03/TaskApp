...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText mCategoryEdit; // カテゴリ追加・課題用
    private Task mTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryEdit = (EditText) findViewById(R.id.category_edit_text); // カテゴリ追加・課題用

        // EXTRA TASKからTaskのidを取得して、idからTaskのインスタンスを取得する
        ...
        if (mTask == null) {
            ...
            mCategoryEdit.setText(mTask.getCategory()); // カテゴリ追加・課題用
    ...
    private void addTask() {
        ...
        String category = mCategoryEdit.getText().toString(); // カテゴリ追加・課題用

        mTask.setTitle(title);
        mTask.setContents(content);
        mTask.setCategory(category); // カテゴリ追加・課題用
        ...
        // 自ActivityからでなくアンドロイドのALARMサービスからブロードキャストしてもらうため、PendingIntent.getBroadcastでPendingIntentオブジェクトを取得しています。
